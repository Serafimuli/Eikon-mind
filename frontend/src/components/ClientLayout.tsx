...
export default function ClientLayout() {
  ...
  const navItems = [
    { to: "/", label: tr.client.home, icon: "⌂" },
    { to: "/client", label: tr.client.overview, icon: "⊞" },
    {
      to: "/client/appointments",
      label: tr.client.myAppointments,
      icon: "◷",
    },
    { to: "/client/book", label: tr.client.bookAppointment, icon: "+" },
    { to: "/client/profile", label: tr.client.profile, icon: "○" },
  ]
